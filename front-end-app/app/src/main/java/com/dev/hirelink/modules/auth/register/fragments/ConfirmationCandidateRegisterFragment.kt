 ...
 * Use the [ConfirmationCandidateRegisterFragment.newInstance] factory method to
...
class ConfirmationCandidateRegisterFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ConfirmationCandidateRegisterFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ConfirmationCandidateRegisterFragment().apply {
